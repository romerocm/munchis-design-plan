...
const esOrder: { [K in keyof typeof order]: string } = {
  ...
  "orderSheet.whatsappPayNote": "Enviaremos un link de pago a tu WhatsApp. Paga en 2 horas para confirmar tu pedido.",
  ...
  "orderStatus.expiredDesc": "La ventana de pago de 2 horas ha pasado. Tu lugar ha sido liberado. No te preocupes — puedes hacer un nuevo pedido si el drop sigue abierto.",
